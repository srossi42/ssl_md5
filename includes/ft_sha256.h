...
typedef unsigned char	t_sha256_byte;
typedef unsigned int	t_sha256_word;
typedef struct			s_sha256_struct
{
	t_sha256_word		state[8];
	t_sha256_word		abcdefgh[8];
	t_sha256_word		count[2];
	t_sha256_byte		buffer[64];
	char				*input;
	unsigned char		*data;
	uint64_t			input_len;
	uint64_t			total_len;
