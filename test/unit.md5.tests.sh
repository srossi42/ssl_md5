...
# Case: option S empty string
	...
	# Run program
	 ./../ft_ssl md5 -s "" > logs/trace_valgrind_$TEST_NAME 2>&1
...
# Case: option S basic string
	...
	# Run program
	 ./../ft_ssl md5 -s "Foo bar" > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: option S edge case 448 bits
	...
	# Run program
	 ./../ft_ssl md5 -s "A very long text with 448 chars, but i need to add more!" > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: option S unicode
	...
	# Run program
	 ./../ft_ssl md5 -s "你吃饭了吗？ Nǐ chīfàn le ma? Literally: Have you eaten?" > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: binary file
	...
	# Run program
	./../ft_ssl md5 resources/binary_file  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: binary file
	...
	# Run program
	cat  resources/binary_file |  ./../ft_ssl md5  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: empty file
	...
	# Run program
./../ft_ssl md5 resources/empty_file  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: empty file
	...
	# Run program
	cat  resources/empty_file |  ./../ft_ssl md5  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: small text file
	...
	# Run program
	 ./../ft_ssl md5 resources/text_file_small  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: small text file
	...
	# Run program
	cat  resources/text_file_small | ./../ft_ssl md5  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: medium text file
	...
	# Run program
	 ./../ft_ssl md5 resources/text_file_medium  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: medium text file
	...
	# Run program
	cat  resources/text_file_medium | ./../ft_ssl md5  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: large text file
	...
	# Run program
	 ./../ft_ssl md5 resources/text_file_large  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
...
# Case: large text file
	...
	# Run program
	cat  resources/text_file_large |  ./../ft_ssl md5  > logs/trace_valgrind_$TEST_NAME 2>&1
	cat logs/trace_valgrind_$TEST_NAME | grep -v "==" | grep -v "\-\- run:" > logs/trace_$TEST_NAME 2>&1
